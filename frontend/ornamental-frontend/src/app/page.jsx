    ...
    <div>
      ...
      <div className="info-div ">
        ...
        >
          ...
          <p className="info-p ">Having a Secret Santa event is always fun, well... only when you know the players well. The last thing you'd want to do is give them a crappy toaster when their kitchen already has 2. That is why we are here today.</p>
          <br></br>
          ...
          <ul className="info-ul ">
              ...
              <li className="info-li "> 🧑‍🤝‍🧑 Get to know the acquaintances you've greeted as an intern for the past 2 months through short interactive questions</li>
              <li className="info-li "> 🎨 Personalize your room, because this room belongs to your unique friend group</li>
              <li className="info-li "> 🎁 Be reminded that as Santa, you have a responsibility to purchase a gift by the decided deadline</li>
              <li className="info-li "> 💌 Feel the pressure, knowing that your peers have already bought their gifts via the presents surrounding the virtual tree</li>
              <li className="info-li "> 🔥 Flame that <span className="highlight"> friend</span> that has yet to buy their gift</li>
