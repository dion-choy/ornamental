  ...
  return (
    <group>
      ...
      >
        ...
        />
        <Gift
          file="/models/BagGift.glb"
          type={"Gift Bag"}
          scale={0.31}
          position={[-3.64, 1.05, -2.54]}
        />
        <Gift
          file="/models/BoxGift.glb"
          type={"Gift Box"}
          scale={0.31}
          position={[-3.66, 1.05, -3.645]}
        />
        <GiftSpawner
      ...
      <Model
        file="/models/christmas_tree.glb"
        position={[0, 0, 0]}
        shadows={shadows}
      />
      <Model
        file="/models/ChristmasRoomVer2.glb"
        position={[0, 0, 0]}
        shadows={shadows}
      />
    </group>
