...
import {
  ...
  SpiralAnimation,
} from "@/components/SecretSantaAnnouncement";
    ...
    getRoom(id).then((roomStr) => {
      ...
      if (jsLoaded) {
        ...
        setInterval(() => {
          ...
          setTimeLeft(
            `${days} Days ${hours >= 10 ? hours : "0" + hours}:${
              mins >= 10 ? mins : "0" + mins
            }:${secs >= 10 ? secs : "0" + secs}`,
          );
        }, 1000);
    ...
    <div className={style.scene}>
      ...
      <Canvas
        ...
        onCreated={({ gl, scene, camera }) => {
          ...
          gl.setSize(
            window.innerWidth /
              (cookies.get("resolution") ? cookies.get("resolution") : 2.5),
            window.innerHeight /
              (cookies.get("resolution") ? cookies.get("resolution") : 2.5),
            false,
          );
      ...
      >
        ...
        />
        <Controls
          rotate={firstTime || !rotation
            ? 0
            : cookies.get("rotation") || rotation}
          camSetting={camSetting}
        />
      </Canvas>
      ...
      <div className={style.overlay}>
        ...
        <div id={style["admin-panel"]}>
          ...
          <button onClick={() => startSecretSanta(id)}>
            Start Secret Santa
          </button>
        ...
        {room.hasOwnProperty("secret_santa") && room.secret_santa.started && (
          <div className={style.giftbutton}>
            ...
            >
              <img
                src={`/assets/${camSetting ? "cancel.png" : "Gift.png"}`}
                alt="Gift!"
              />
