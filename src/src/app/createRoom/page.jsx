...
import { CalendarCard, InputCard, ResultCard } from "@/components/SetupCards";
...
function createRoomPage() {
  const [cards, setCards] = useState([
    {
      subtitle: "Every iconic group has a name",
      placeholder: "Enter your iconic name",
      cardNum: "1",
    },
    {
      subtitle: "When should the gifts be exchanged?",
      placeholder: "Select a date",
      cardNum: "2",
    },
    {
      subtitle: "Let's make this room uniquely yours",
  ...
  async function conf() {
    ...
    createRoom(code, groupName, date, 50, groupDesc, 5, selectedQuestions).then(
      (res) => {
    ...
    <>
      ...
      {finalCard
        ? (
          ...
          >
            <ResultCard
              subtitle={"Does this sound like your room?"}
              cardNum={4}
              groupName={groupName}
              date={date}
